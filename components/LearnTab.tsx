      ...
      <div className="grid gap-4 xl:grid-cols-2">
        {articles.map((article) => (
          <article
            ...
            className="rounded-[2rem] border border-stone-100 bg-white p-6 shadow-[0_18px_70px_rgba(76,149,108,0.08)]"
          >
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              <div className="rounded-full bg-[#f0f0f0] px-3 py-2 text-xs text-stone-500">
