...
type DailyCheckInPeriod = Exclude<CheckInPeriod, 'weekly'>

export function getDailyQuestionId(period: DailyCheckInPeriod, field: string) {
  return `${period}_${field}`
}

function createDailyQuestions(period: DailyCheckInPeriod): QuestionDefinition[] {
  return [
    {
      id: getDailyQuestionId(period, 'feeling'),
      period,
      kind: 'slider',
    ...
    {
      id: getDailyQuestionId(period, 'energy'),
      period,
      kind: 'single_choice',
    ...
    {
      id: getDailyQuestionId(period, 'sleep'),
      period,
      kind: 'single_choice',
    ...
    {
      id: getDailyQuestionId(period, 'pain'),
      period,
      kind: 'slider',
    ...
    {
      id: getDailyQuestionId(period, 'stress'),
      period,
      kind: 'slider',
    ...
    {
      id: getDailyQuestionId(period, 'social_connection'),
      period,
      kind: 'single_choice',
    ...
    {
      id: getDailyQuestionId(period, 'routine'),
      period,
      kind: 'single_choice',
    ...
    {
      id: getDailyQuestionId(period, 'meals'),
      period,
      kind: 'single_choice',
    ...
    {
      id: getDailyQuestionId(period, 'environment'),
      period,
      kind: 'single_choice',
    ...
    {
      id: getDailyQuestionId(period, 'medication'),
      period,
      kind: 'single_choice',
    ...
    {
      id: getDailyQuestionId(period, 'activity'),
      period,
      kind: 'single_choice',
...
export const QUESTION_BANK: QuestionDefinition[] = [
  ...createDailyQuestions('morning'),
  ...createDailyQuestions('night'),
  {
    id: 'weekly_socialize',
    period: 'weekly',
    kind: 'single_choice',
